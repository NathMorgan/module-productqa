...
namespace Bright\ProductQA\Test\Unit\Model\Data;

use PHPUnit\Framework\TestCase;
use Magento\Framework\TestFramework\Unit\Helper\ObjectManager;
use Bright\ProductQA\Model\Data\Question;
...
class QuestionTest extends TestCase
{
    ...
    /**
     * testSetup function for creating mock classes
     *
     * @return void
     */
    public function setUp(): void
    {
        $this->question = (new ObjectManager($this))->getObject(Question::class);
    }
